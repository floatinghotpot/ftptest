...
#from ftptest.version import __version__
lines = open(here + '/ftptest/version.py', mode='r').readlines()
for line in lines:
...
setuptools.setup(
    ...
    url = 'https://github.com/floatinghotpot/ftptest',
    download_url = 'https://github.com/floatinghotpot/ftptest',
    ...
    entry_points={'console_scripts': ['ftptest=ftptest:cli_main']},
